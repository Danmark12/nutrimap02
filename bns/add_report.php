...
<body>
                ...
                <div class="form-wrapper">
                    <form method="post">
                        ...
                        <h3 style="text-align:center; margin:0;"><strong>Calendar Year</strong> 
                            <input type="number" name="year" id="yearInput" style="width:80px;"> &nbsp;&nbsp;
                        </h3>
    ...
    <script>
        ...
        [ind8, ind9].forEach(input => {
            if (input) input.addEventListener('input', computeMeasuredCoverage);
        });
        ...
        [ind18, ind19, ind20].forEach(input => {
            if (input) input.addEventListener('input', computeInd21);
        });
