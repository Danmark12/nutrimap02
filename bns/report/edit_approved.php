...
<form action="update_report.php" method="post" onsubmit="copyTitle()">
    ...
    <tr><td>6. Total Number of Women Who Are:</td><td></td>
    </tr>
  ...
  <tr><td>18. Total Number of Children Enrolled in Kindergarten</td>
    ...
    <tr><td>37. Number of Health and Nutrition Workers:</td><td></td>
    </tr>
    <tr class="indent">
...
<script>
// ============================================
// UPDATE REPORT FORMULAS - MATCHING ADD REPORT PAGE
// ============================================
